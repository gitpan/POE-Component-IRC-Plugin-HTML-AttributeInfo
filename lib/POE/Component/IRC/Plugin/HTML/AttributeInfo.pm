...
(it defaults to C<irc_html_attribute>) will recieve input
...
Please report any bugs or feature requests to C<bug-poe-component-irc-plugin-html-attributeinfo at rt.cpan.org>, or through
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=POE-Component-IRC-Plugin-HTML-AttributeInfo>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=POE-Component-IRC-Plugin-HTML-AttributeInfo>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/POE-Component-IRC-Plugin-HTML-AttributeInfo>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/POE-Component-IRC-Plugin-HTML-AttributeInfo>

=item * Search CPAN

L<http://search.cpan.org/dist/POE-Component-IRC-Plugin-HTML-AttributeInfo>
